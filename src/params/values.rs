...
// Lazy PSTs
#[rustfmt::skip]
pub const LAZY_PAWN_PST: [Score; 64] = [
    s!(   0,    0), s!(   0,    0), s!(   0,    0), s!(   0,    0), s!(   0,    0), s!(   0,    0), s!(   0,    0), s!(   0,    0),
...
#[rustfmt::skip]
pub const LAZY_KNIGHT_PST: [Score; 64] = [
...
#[rustfmt::skip]
pub const LAZY_BISHOP_PST: [Score; 64] = [
...
#[rustfmt::skip]
pub const LAZY_ROOK_PST: [Score; 64] = [
...
#[rustfmt::skip]
pub const LAZY_QUEEN_PST: [Score; 64] = [
...
#[rustfmt::skip]
pub const LAZY_KING_PST: [Score; 64] = [
